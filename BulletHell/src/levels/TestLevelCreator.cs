...
namespace BulletHell.levels
{
    public class TestLevelCreator : IGameFactory
    {
        ...
        public Tuple<GameDirector, Canvas, CollisionManager> makeGame(GraphicsDevice graphicsDevice, Controller controller)
        {
            ...
            // List<PathData> pData = new List<PathData>(new PathData("linear", 5000, 0, 1));
            PathData pData1 = new PathData("linear", 5000, 0, 1);
            Enemy e1 = enemyFactory.makeEnemy("enemyA", 10, new Vector2(200,200), pData1, null);
