...
namespace BulletHell.GameEngine
{
    public class BossGun : Gun
    {
        ...
        public BossGun(int amountOfBullets, float direction, float spread, int damage, ILocationEquation shape, Texture2D texture, int delay, TEAM team) : base(damage, shape, texture, delay, team)
        {
